...
#ifndef UNSIGNED_INTEGER__STATUS_MANAGEMENT_HH
#define UNSIGNED_INTEGER__STATUS_MANAGEMENT_HH
...
namespace Planning
{
    ...
    public:
        ...
        void set_satisfaction(uint i, uint value);
        uint get_satisfaction_level(uint i) const;
    protected:
        /* Derived from \parent{Markov_Decision_Process_State} fields.*/
        Integer_State status;
    };
}
